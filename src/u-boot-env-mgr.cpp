    ...
    server(srv_), conn(conn_)
{
    ...
    iface->register_method("ReadAll",
                           [this]() { return this->readAllVariable(); });
    iface->register_method("Read", [this](const std::string& key) {
        std::unordered_map<std::string, std::string> env =
            this->readAllVariable();
    ...
    iface->register_method("Write", [this](const std::string& key, const std::string& value) {
